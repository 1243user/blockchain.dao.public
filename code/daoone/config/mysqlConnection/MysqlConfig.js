...
const $localAddr = Symbol('localAddr');
const $socketPath = Symbol('socketPath');
const $user = Symbol('user');
const $pwd = Symbol('pwd');
const $db = Symbol('db');
const $charset = Symbol('charset');
const $timezone = Symbol('timezone');
const $connTimeout = Symbol('connTimeout');
const $stringifyObjs = Symbol('stringifyObjs');
const $typeCast = Symbol('typeCast');
const $queryFormat = Symbol('queryFormat');
const $supportBigNumbers = Symbol('supportBigNumbers');
const $bigNumberStrings = Symbol('bigNumberStrings');
const $dateStrings = Symbol('dateStrings');
const $debug = Symbol('debug');
const $trace = Symbol('trace');
const $multiStmts = Symbol('multipleStatements');
...
class MysqlConfig {
    ...
    set typeCast(val) { this[$typeCast] = val }
